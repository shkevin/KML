/*!
 * @file KMatrix.h
 * @brief Provides the declaration for matrix wrapper. This class can either
 *        be of the KSimpleMatrix class or Eigen.
 */
...
#ifndef WITH_EIGEN
/*!
 * @brief Whether to build KMatrix with Eigen support or use KSimpleMatrix.
 */
constexpr auto WITH_EIGEN = 0  // Set with build options.
